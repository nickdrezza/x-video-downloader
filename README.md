...
A tiny native macOS app for downloading and compressing media from X/Twitter, Reddit, and RedGifs. Paste links or choose local files, set an optional target size, and keep the processing local.
...
- Download + compress mode for X/Twitter, Reddit, `redd.it`, and RedGifs links
